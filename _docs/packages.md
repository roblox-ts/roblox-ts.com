...
Your `rojo.json` file should have a partition to sync modules into studio. Refer to the roblox-ts README for more information.
...
1. Create a `src` folder and copy the `tsconfig.json` from the roblox-ts README.
