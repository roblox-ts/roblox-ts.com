...
- "repository" - If your package is public on something like GitHub, you should include a link to it in this field.
...
- "license" - The license of your package's code. This should represent what is in your `LICENSE` file.
